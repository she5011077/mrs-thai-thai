...
import { Post, PostStatus, STATUS_LABELS, STATUS_STYLES } from '@/lib/types';
...
interface EditModalProps {
  ...
  onCreate: (day: number, data: Partial<Post>) => Promise<void>;
  onDelete: (id: string) => Promise<void>;
}

export default function EditModal({ day, post, onClose, onSave, onCreate, onDelete }: EditModalProps) {
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-4">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <div className="text-[11px] text-gray-400">Day {day}</div>
                  </div>
                </div>
